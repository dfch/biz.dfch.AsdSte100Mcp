# Contributing to biz.dfch.AsdSte100Mcp

Thank you for your interest in contributing to **biz.dfch.AsdSte100Mcp**!  
...
- **Bug reports**: Open an issue in the GitHub issue tracker:
  - URL: `https://github.com/dfch/biz.dfch.AsdSte100Mcp/issues`
  - Include:
    - Steps to reproduce
    - Expected behavior
    - Actual behavior
...
```bash
git clone https://github.com/dfch/biz.dfch.AsdSte100Mcp.git
cd biz.dfch.AsdSte100Mcp
